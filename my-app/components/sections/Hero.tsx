    ...
    export default function Hero() {
        ...
        return (
            <div className="w-full min-h-screen relative overflow-hidden flex items-center pt-24 pb-16">
                ...
                {mounted && (
                    <motion.button
                        ...
                        className="fixed top-10 right-1 z-50 p-3 rounded-full border border-neutral-200 dark:border-neutral-800 bg-white/50 dark:bg-black/50 backdrop-blur-md text-neutral-800 dark:text-neutral-200"
                    >
                        {theme === "dark" ? (
